...
public class Complain extends javax.swing.JFrame {
    ...
    public Complain(String Transfer1) {              // Retrive PIN from Main Frame
        initComponents();
        Trans.setText(Transfer1);
    ...
    private void initComponents() {
        ...
        jPanel2.add(Panel1);
        Panel1.setBounds(450, 20, 430, 280);
    ...
    private void BComActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BComActionPerformed
        ...
        try {               // Getting connection with non_register table in mysql
            ...
            String query = "SELECT *,sysdATE() FROM a_register WHERE phone='" + Ph + "';";
